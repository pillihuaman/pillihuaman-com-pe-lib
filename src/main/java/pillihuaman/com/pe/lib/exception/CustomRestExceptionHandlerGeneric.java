...
/*
    ...
    protected ResponseEntity<Object> handleNoHandlerFoundException(NoHandlerFoundException ex, HttpHeaders headers, HttpStatus status, WebRequest request) {
        ...
        ErrorResponseApiGeneric errorResponseApi = new ErrorResponseApiGeneric(HttpStatus.NOT_FOUND.value(), ex.getBody().getDetail(), error);
        return new ResponseEntity<>(errorResponseApi, new HttpHeaders(), status);
    }
    ...
    protected ResponseEntity<Object> handleHttpRequestMethodNotSupported(HttpRequestMethodNotSupportedException ex, HttpHeaders headers, HttpStatus status, WebRequest request) {
        ...
        ErrorResponseApiGeneric errorResponseApi = new ErrorResponseApiGeneric(HttpStatus.METHOD_NOT_ALLOWED.value(), ex.getBody().getDetail(), builder.toString());
        return new ResponseEntity<>(errorResponseApi, new HttpHeaders(), status);
    }
    ...
    protected ResponseEntity<Object> handleHttpMediaTypeNotSupported(HttpMediaTypeNotSupportedException ex, HttpHeaders headers, HttpStatus status, WebRequest request) {
        ...
        ErrorResponseApiGeneric errorResponseApi = new ErrorResponseApiGeneric(HttpStatus.UNSUPPORTED_MEDIA_TYPE.value(), ex.getBody().getDetail(), builder.substring(0, builder.length() - 1));
        return new ResponseEntity<>(errorResponseApi, new HttpHeaders(), status);
    }
    ...
    protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex, HttpHeaders headers, HttpStatus status, WebRequest request) {
        ...
        ErrorResponseApiGeneric errorResponseApi = new ErrorResponseApiGeneric(HttpStatus.BAD_REQUEST.value(), ex.getMessage(), message);
        return new ResponseEntity<>(errorResponseApi, new HttpHeaders(), status);
    }
    ...
    protected ResponseEntity<Object> handleTypeMismatch(TypeMismatchException ex, HttpHeaders headers, HttpStatus status, WebRequest request) {
        ...
        ErrorResponseApiGeneric errorResponseApi = new ErrorResponseApiGeneric(HttpStatus.BAD_REQUEST.value(), ex.getMessage(), error);
        return new ResponseEntity<>(errorResponseApi, new HttpHeaders(), status);
    }
    ...
    protected ResponseEntity<Object> handleMissingServletRequestPart(MissingServletRequestPartException ex, HttpHeaders headers, HttpStatus status, WebRequest request) {
        ...
        ErrorResponseApiGeneric errorResponseApi = new ErrorResponseApiGeneric(HttpStatus.BAD_REQUEST.value(), ex.getBody().getDetail(), error);
        return new ResponseEntity<>(errorResponseApi, new HttpHeaders(), status);
    }
    ...
    public ResponseEntity<Object> handleUnprocessableEntityException(UnprocessableEntityException ex) {
        ErrorResponseApiGeneric errorResponseApi = new ErrorResponseApiGeneric(HttpStatus.UNPROCESSABLE_ENTITY.value(),ex.getMessage(), ex.getMessage());
    ...
    protected ResponseEntity<Object> handleCreatedException(CreatedException ex) {
        ErrorResponseApiGeneric errorResponseApi = new ErrorResponseApiGeneric(HttpStatus.CREATED.value(), ex.getMessage(), ex.getMessage());
    ...
    private String getLocalizedMessageOrDefault(MethodArgumentNotValidException ex) {
        return (ex.getBody().getDetail() != null) ? ex.getBody().getDetail() : "Validation error";
    }
